                ...
                <div class="px-6 py-4 border-b border-sky-100/70 bg-sky-50/60 flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
                    ...
                    <div class="shrink-0">
                        <a
                            ...
                            class="inline-flex items-center gap-1.5 rounded-xl px-4 py-2 text-xs font-bold text-white bg-gradient-to-r from-sky-600 to-indigo-600 hover:from-sky-700 hover:to-indigo-700 shadow-[0_2px_8px_rgb(14,165,233,0.4)] transition-all hover:shadow-[0_4px_12px_rgb(14,165,233,0.5)] hover:-translate-y-px active:translate-y-0"
                        >
                            <i data-lucide="plus" class="h-3.5 w-3.5"></i> Tambah Prodi
                        </a>
                    </div>
                </div>
                    ...
                    <table class="w-full min-w-[980px] text-sm text-left text-slate-600">
                        <thead class="text-xs text-sky-700 uppercase bg-sky-50/80">
                            <tr>
                                ...
                                <th class="px-6 py-4 font-semibold tracking-wider">Kode Pendaftaran</th>
                            ...
                            @forelse ($programStudis as $prodi)
                                <tr class="hover:bg-sky-50/40 transition-colors">
                                    ...
                                    <td class="px-6 py-4 font-medium text-indigo-600">
                                        @if($prodi->registration_code)
                                            <code class="px-2 py-1 bg-indigo-50 border border-indigo-100 rounded text-xs">{{ $prodi->registration_code }}</code>
                                        @else
                                    ...
                                    <td class="w-[220px] px-6 py-4 whitespace-nowrap">
                                        <div class="flex flex-nowrap items-center justify-end gap-2">
                                            <a
                                                href="{{ route('admin.program-studi.edit', $prodi) }}"
