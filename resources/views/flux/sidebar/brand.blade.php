...
// PATCHED: replaced [:where(&)]:text-zinc-800 (zero specificity, often overridden by accent vars)
// with direct text-slate-900 font-semibold for guaranteed visibility on white sidebar
$textClasses = Flux::classes()
    ->add('text-sm font-semibold truncate text-slate-900')
    ;
@endphp
