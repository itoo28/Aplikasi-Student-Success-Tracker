...
### 1. Tim 1 (User / Anda) - Modul Poin SKKM
...
### 2. Tim 2 (Teman Anda) - Modul Laporan Dosen PA
...
3.  **Jangan Sentuh Modul Lain:** Jika menemukan bug atau kode yang bisa dioptimalkan di modul milik tim lain (saat sedang mengerjakan tugas di suatu modul), **ABAIKAN**. Fokus hanya pada modul yang sedang ditugaskan untuk mencegah konflik *merge* atau kerusakan pada pekerjaan tim lain.
